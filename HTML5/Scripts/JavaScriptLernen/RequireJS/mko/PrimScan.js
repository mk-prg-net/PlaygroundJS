...
define(["./CreateCancellationToken"], function (CreateCancellationToken) {


    PrimTest = function (candidate) {
    ...
    PrimScan = function (begin, end, done, fail, progressInfo) {

        // Abbruchtoken. Über dieses kann der Rufer den asynchronen Berechnungsprozess vorzeitig stoppen.
        var CancellationToken = CreateCancellationToken();

        return PrimScanWithCancel(CancellationToken, begin, end, done, fail, progressInfo);
    };


    // doneCallback(CancellationToken, PrimNums[])
    // progressInfo(Anzahl bereits gefundener)
    PrimScanWithCancel = function (CancellationToken, begin, end, done, fail, progressInfo) {
