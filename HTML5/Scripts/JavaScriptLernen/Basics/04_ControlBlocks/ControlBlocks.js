...
function Kontrollstrukturen() {
    ...
    // Rekursive Programme
    var Ergebnis = GuthabenRecu(3, 1000, 10.0 / 100.0);
}
...
function GuthabenRecu(laufzeit, startkapital, zinssatz) {
    if (laufzeit == 0)
        return startkapital;
    else
        return GuthabenRecu(laufzeit - 1, startkapital, zinssatz) * (1 + zinssatz);
}
